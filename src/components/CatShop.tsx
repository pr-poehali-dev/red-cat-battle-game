...
const CatShop: React.FC<CatShopProps> = ({ gameStats, onPurchase }) => {
  const [cats] = useState<Cat[]>([
    ...
    },
    {
      ...
      detailedDescription: 'ЛЕГЕНДАРНЫЙ КОТ ПЫЛЬ! ✨ Мистический воин, чьё тело состоит из космической пыли звёзд. Обладает невероятной силой и скоростью. Его атаки разрывают пространство, а защита непробиваема как сама вечность. Легенды гласят, что этот кот родился из пыли сверхновой звезды и хранит в себе силу целой галактики. Самый мощный боец во всей вселенной! 💫 Максимальные характеристики для абсолютного доминирования!'
    }
  ])
