...
const CatShop: React.FC<CatShopProps> = ({ gameStats, onPurchase }) => {
  const [cats] = useState<Cat[]>([
    ...
    },
    {
      ...
      description: 'Легендарный воин - самый мощный кот в галактике!',
      detailedDescription: 'ЛЕГЕНДАРНЫЙ КОТ ПЫЛЬ! ✨ Мистический воин, чьё тело состоит из космической пыли звёзд. Обладает невероятной силой и скоростью. Его атаки разрывают пространство, а защита непробиваема как сама вечность. Легенды гласят, что этот кот родился из пыли сверхновой звезды и хранит в себе силу целой галактики. Самый мощный боец во всей вселенной! 💫\n\n⚡ УНИКАЛЬНАЯ СПЕЦСПОСОБНОСТЬ: "Звёздный Взрыв" - с шансом 15% наносит урон х5! Кулдаун 30 секунд. Эпическая анимация космических частиц!'
    }
  ])
